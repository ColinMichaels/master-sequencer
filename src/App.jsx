...
function AddTracksForm({ album, scanning, onlineApp = false, onChoose, onReviewPath, onAddBlank, onCancel }) {
  ...
  return (
    <div className="modal-form add-tracks-form">
      ...
      {onlineApp && <p className="online-privacy-note"><strong>Device audio stays private:</strong> choose files or a folder. Supported browsers can reconnect after reload; audio still plays directly from your device and is never uploaded.</p>}
