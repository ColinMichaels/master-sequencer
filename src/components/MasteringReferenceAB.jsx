...
export function MasteringReferenceAB({
  ...
  return (
    <section className={`reference-ab-panel ${activeChannel ? "is-monitoring" : ""}`} aria-labelledby="reference-ab-title">
      <div className="reference-ab-heading">
        <span className="reference-ab-mark"><MusicIcon /> A/B</span>
        <div><h3 id="reference-ab-title">Reference Track</h3><p>Compare the current live master with one indexed source. B always takes the clean direct path around track gain and every MASTER effect.</p></div>
      </div>
