...
export function SettingsWorkspace({ state, roots, scan, watching, scanning, onlineApp = false, projectArtistName, currentProject, projects, projectBusy, revealPrivateFilenames, appearance, resolvedMode, onProjectIdentityChange, onAppearanceChange, onTogglePrivate, onAddRoot, onRemoveRoot, onChooseSources, onReconnectSource, onRescan, onImportState, onOpenProjects, onNewProject, onExportBundle }) {
